rule Detect_Hidden_Data_In_WAV {
    meta:
        description = "Detectează date ascunse sau cod malitios în fișiere WAV"
        author = "GuardianBit"
        date = "2023-10-01"
        severity = "HIGH"
...
rule Detect_Suspicious_URLs_In_WAV {
    meta:
        description = "Detectează URL-uri suspecte în fișiere WAV"
        author = "GuardianBit"
        date = "2023-10-01"
        severity = "MEDIUM"
...
rule Detect_Obfuscated_Data_In_WAV {
    meta:
        description = "Detectează date ofuscate sau criptate în fișiere WAV"
        author = "GuardianBit"
        date = "2023-10-01"
        severity = "HIGH"
...
rule Detect_Suspicious_Commands_In_WAV {
    meta:
        description = "Detectează comenzi suspecte în fișiere WAV"
        author = "GuardianBit"
        date = "2023-10-01"
        severity = "HIGH"
...
rule Detect_Executable_Code_In_WAV {
    meta:
        description = "Detectează fragmente de cod executabil în fișiere WAV"
        author = "GuardianBit"
        date = "2023-10-01"
        severity = "HIGH"
...
rule Detect_Suspicious_Metadata_In_WAV {
    meta:
        description = "Detectează metadate suspecte în fișiere WAV"
        author = "GuardianBit"
        date = "2023-10-01"
        severity = "MEDIUM"
...
rule Detect_Suspicious_Structures_In_WAV {
    meta:
        description = "Detectează structuri suspecte în fișiere WAV"
        author = "GuardianBit"
        date = "2023-10-01"
        severity = "HIGH"

    strings:
        $riff_header = "RIFF"  // Header RIFF
        $wave_header = "WAVE"  // Header WAVE
        $data_chunk = "data"   // Chunk-ul de date
