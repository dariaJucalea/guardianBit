rule Detect_Hidden_Data_In_MP3 {
    meta:
        description = "Detectează date ascunse sau cod malitios în fișiere MP3"
        author = "GuardianBit"
        date = "2023-10-01"
        severity = "HIGH"
...
rule Detect_Suspicious_URLs_In_MP3 {
    meta:
        description = "Detectează URL-uri suspecte în fișiere MP3"
        author = "GuardianBit"
        date = "2023-10-01"
        severity = "MEDIUM"
...
rule Detect_Obfuscated_Data_In_MP3 {
    meta:
        description = "Detectează date ofuscate sau criptate în fișiere MP3"
        author = "GuardianBit"
        date = "2023-10-01"
        severity = "HIGH"
...
rule Detect_Suspicious_Commands_In_MP3 {
    meta:
        description = "Detectează comenzi suspecte în fișiere MP3"
        author = "GuardianBit"
        date = "2023-10-01"
        severity = "HIGH"
...
rule Detect_Executable_Code_In_MP3 {
    meta:
        description = "Detectează fragmente de cod executabil în fișiere MP3"
        author = "GuardianBit"
        date = "2023-10-01"
        severity = "HIGH"
...
rule Detect_Suspicious_Metadata_In_MP3 {
    meta:
        description = "Detectează metadate suspecte în fișiere MP3"
        author = "GuardianBit"
        date = "2023-10-01"
        severity = "MEDIUM"
